...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
    ...
    <!-- Header Start -->
    <header id="header">
        <nav class="navbar navbar-fixed w-100">
    ...
    <!-- SINGLE PRODUCT
    ============================================= -->
    <section id="product-1" class="single-product">
        <div class="container">
            <div class="row">
                    ...
                    <div class="videos-slider-2">
                        <div>
                          <div class="bs-overlay">
                            <img src="src/assets/img/menu-slider/menu_1.png" alt="" />
                      
                          </div>
                        </div>
                        <div>
                          <div class="bs-overlay">
                            <img src="src/assets/img/menu-slider/menu_2.png" alt="" />
                
                          </div>
                        </div>
                        <div>
                          <div class="bs-overlay">
                            <img src="src/assets/img/menu-slider/menu_3.png" alt="" />
                     
                          </div>
                        </div>
                        <div>
                          <div class="bs-overlay">
                            <img src="src/assets/img/menu-slider/menu_4.png" alt="" />
                      ...
                      <div class="slider-nav-thumbnails">
                        <div>
                          <img src="src/assets/img/menu-slider/menu_1.png" alt="One">
                        </div>
                        <div>
                          <img src="src/assets/img/menu-slider/menu_2.png" alt="Two">
                        </div>
                        <div>
                          <img src="src/assets/img/menu-slider/menu_3.png" alt="Three">
                        </div>
                        <div>
                          <img src="src/assets/img/menu-slider/menu_4.png" alt="Four">
                        </div>
                      </div>
                ...
                <div class="col-lg-5">
                    <div class="product-description">
                        ...
                        <!-- Title -->
                        <h2 class="product-title">Smokey House</h2>
                        ...
                        <div class="product-price">
                            <h4 class=""><span class="old-price">$9.95</span> $8.60</h4>
                        </div>
                        
                        <!-- Text -->
                        <p class="product-text">Integer congue magna at pretium purus pretium ligula rutrum risus ultrice luctus
                        ...
                        <!-- List -->	
                        <ul class="txt-list">
                            <li class="list-item"><p>We accept credit cards or cash to a courier</p></li>
                            <li class="list-item"><p>Shipping cost is $2 (Free from $35)</p></li>
                            <li class="list-item"><p>Order before noon for same day dispatch</p></li>
                        </ul>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="menu-item bg-white">
                        ...
                        <div class="menu-img">
                            ...
                            <!-- Image -->
                            <a href="src/assets/img/menu-slider/menu_1.png" class="d-block fancybox text-center">
                                <img class="img-fluid" src="src/assets/img/menu-slider/menu_1.png" alt="menu-image">
                            </a>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="menu-item bg-white">
                        ...
                        <div class="menu-img">
                            ...
                            <!-- Image -->
                            <a href="src/assets/img/menu-slider/menu_2.png" class="d-block fancybox text-center">
                                <img class="img-fluid" src="src/assets/img/menu-slider/menu_2.png" alt="menu-image">
                            </a>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="menu-item bg-white">
                        ...
                        <div class="menu-img">
                            ...
                            <!-- Image -->
                            <a href="src/assets/img/menu-slider/menu_3.png" class="d-block fancybox text-center">
                                <img class="img-fluid" src="src/assets/img/menu-slider/menu_3.png" alt="menu-image">
                            </a>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="menu-item bg-white">
                        ...
                        <div class="menu-img">
                            ...
                            <!-- Image -->
                            <a href="src/assets/img/menu-slider/menu_4.png" class="d-block fancybox text-center">
                                <img class="img-fluid" src="src/assets/img/menu-slider/menu_4.png" alt="menu-image">
                            </a>
