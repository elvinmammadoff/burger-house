    ...
    <nav class="navbar affix-top">
        <div id="navbar_content">
            <div class="navbar-header">
                <a class="navbar-brand custom-primary" href="#"><img src="src/assets/img/logo.png" alt="logo" /> Kebab House</a>
    ...
    <div class="banner-slider">
        <div class="banner-slider__item">
            <div class="banner-slider__text custom-primary">
                <h3 class="banner-subtitle" data-aos="fade-up">It is a good time for the great taste of kebabs</h3>
                <h1 class="banner-title" data-aos="fade-up" data-aos-duration="1800">Turkish <span>Kebab</span></h1>
            </div>
        ...
        <div class="banner-grid-column">
            <a href="" title="" class="banner-grid-big">
                <div class="banner-grid-text">
                    ...
                    <h3 class="banner-grid-title">Most popular kebab</h3>
                </div>
                <img src="src/assets/img/banner-grid/2.png" alt="" class="banner-grid-image" />
            </a>
        </div>
        <div class="banner-grid-column">
            <a href="" title="" class="banner-grid-small">
                ...
                <img src="src/assets/img/banner-grid/3.png" alt="" class="banner-grid-image" />
            </a>
            <a href="" title="" class="banner-grid-small">
                <div class="banner-grid-text">
                    <h4 class="banner-grid-subject">Try it today</h4>
                ...
                <img src="src/assets/img/banner-grid/4.png" alt="" class="banner-grid-image" />
            </a>
        </div>
    </div>
</div>
    ...
    <div id="menu-slider" class="menu-slider">
        <div class="menu-slider-item">
            <div class="menu-slider-item-image">
                ...
                <!--                    <img src="src/assets/img/shadow.png" alt="" class="menu-slider-item-shadow" />-->
            </div>
        ...
        <div class="events-wrapper">
            <div class="events-item">
                <div class="section-header">
                    <h5 class="section-label">Discover</h5>
                ...
                <img src="src/assets/img/events/event_1.png" alt="" class="events-item-image" />
            </div>
            <div class="events-item">
                <div class="section-header">
                ...
                <img src="src/assets/img/events/event_2.png" alt="" class="events-item-image" />
            </div>
            <div class="events-item">
                <div class="section-header">
                    <h5 class="section-label">Discover</h5>
...
<section class="section" id="reservation">
    <div class="reservation">
        <div class="reservation-left">
            <img src="src/assets/img/reservation/15.png" alt="" />
            <img src="src/assets/img/reservation/17.png" alt="" />
        </div>
        ...
        <div class="reservation-right">
            <img src="src/assets/img/reservation/16.png" alt="" />
        </div>
    </div>
</section>
<!-- Reservation End -->
